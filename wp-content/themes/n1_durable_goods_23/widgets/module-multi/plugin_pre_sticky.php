...
class Module_Multi extends WP_Widget {
        ...
        switch ($flavor) {
                ...
                switch ($format) {
                    case 'pullquote':
                      ...
                      <article
                        ...
                        <div class="jump"><a href="<?php echo get_permalink($the_p->ID) ?>"
                                             class="jump"><?php _e('Read More') ?></a></div>
                      ...
                      <article
                        class="post <?php echo $featured ?> <?php echo $article_type ?> term-<?php echo $section->slug ?>">
                          ...
                          <?php if ($article_type == 'magazine' && (!!$featured || $format == 'with_image')) {
                              ...
                              if (is_array($img_src)) {
                                  ?>
                                <figure class="post-figure"><img class="post-figure"
                                                                 src="<?php echo $img_src[0] ?>"
                                                                 alt="<?php echo $the_p->post_title ?>"/>
                                </figure>
                              <?php }
                          } else if ($format == 'with_image') { ?>
                            <a
            ...
            default:
              ...
              <div
                ...
                <a class="module article wrapper" href="<?php echo get_permalink($the_p->ID) ?>">
                    <?php echo $flags; ?>
                    <?php echo $content; ?>
    ...
    function get_flags($flavor, $the_p, $section) {
        $is_scroll_post = !!reset(wp_get_post_terms($the_p->ID, array('online-only')));
        $issue = reset(wp_get_post_terms($the_p->ID, array('issue')));
