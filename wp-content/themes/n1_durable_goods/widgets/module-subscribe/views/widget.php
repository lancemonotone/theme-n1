<?php $context_issue = N1_Magazine::Instance()->context_issue;?>
...
<?php if(N1_Magazine::Instance()->is_paywalled()){?>
<section class="subscribe">
	<div class="subscribe category"><span class="module-hed"><?php _e('Available Now')?></span></div>
	<h3 class="subscribe issuetitle"><?php echo N1_Magazine::Instance()->current_issue->post_title?>: <?php echo get_field('issue_name', $context_issue->ID)?></h3>
