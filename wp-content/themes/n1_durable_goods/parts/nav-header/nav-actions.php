...
function get_status(): string {
	...
	$user_status  = __( mm_member_data( array( "name" => "statusName" ) ) );
...
<div class="status-container">
    ...
    <div class="links">
        <a href="{$home_url}/my-account/">{$account_text}</a>
        <a href="https://shop.nplusonemag.com/products/gift-subscription">{$gift_text}</a>
    </div>
