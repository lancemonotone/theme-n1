...
<div id="main" class="main-magazine-home main magazine-home wrapper cf">
    <div id="magazine-archive" class="als-container">
        <div class="list_carousel responsive">
            ...
            <a id="next3" class="als-next next" href="#">
                <img title="next" alt="next" src="<?php echo get_stylesheet_directory_uri() ?>/assets/build/images/r-black.png">
            </a>
            <a id="prev3" class="als-prev prev" href="#">
                <img title="previous" alt="prev" src="<?php echo get_stylesheet_directory_uri() ?>/assets/build/images/l-black.png">
            </a>
        </div>
