...
$headers['ctransreceipt'] = array('content' => '<a onclick="mmjs.sort(\'ctransreceipt\');" href="#">Receipt</a>', "attr" => "style='width:150px;'");
$headers['ctransaction'] = array('content' => '<a onclick="mmjs.sort(\'ctransaction\');" href="#">Transaction Type</a>', "attr" => "style='width:150px;'");
