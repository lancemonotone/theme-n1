				...
				{	
					...
					switch($params[MM_ActivityLog::$PARAM_ACCESS_EVENT])
					{
						...
						case MM_Event::$MEMBER_MERGED:
						    $eventType = MM_Utils::getIcon('compress', 'salmon', '1.3em', '2px', "Member account merged");
						    $details = "Member account <em>".$params["email"]."</em> [ID: ".$params["member_id"]."] merged into this account";
						    break;
