			...
			<td valign="top">
				<div id="mm-email-service-provider-list-bundle-mappings" style="display:none; margin-top: 20px; margin-left:20px;">
					...
					<div class="mm-button-container">
						<a onclick="mmjs.create('mm-bundle-mapping-dialog', 475, 255)" class="mm-ui-button green"><?php echo MM_Utils::getIcon('plus-circle', '', '1.2em', '1px'); ?> <?php echo _mmt("Create Bundle Mapping"); ?></a>
					</div>
