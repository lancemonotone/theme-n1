...
$membershipList = MM_HtmlUtils::getMemberships($associatedMembership->getId(), false, MM_MembershipLevel::$SUB_TYPE_PAID, true);
...
<div id="mm-form-container">
	...
	<tr>
		<td>
			Purchase Confirmation Message<?php echo MM_Utils::getInfoIcon("Enter a purchase confirmation message for this product. It will be displayed to the member when they click to purchase a product using a card on file."); ?>
		</td> 
		<td>
			<div>
				...
				Insert template: <a href="javascript:insertBasicTemplate();" style="color:#21759B;">Product Information</a>, <a href="javascript:insertAdvancedTemplate();" style="color:#21759B;">Collect Shipping/Coupon Info</a>
				<br/>
				<?php echo MM_Utils::getIcon('lightbulb-o', 'yellow', '1.3em', '2px'); ?>
				<a href="https://support.membermouse.com/support/solutions/folders/9000194192" target="_blank" style="color:#21759B;">Learn more about configuring the confirmation message</a>
			</div>
