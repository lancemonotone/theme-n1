...
<div class="mm-wrap">
	<div class="mm-button-container">
		<a onclick="mmjs.create('mm-shipping-dialog', 300, 210)" class="mm-ui-button green"><?php echo MM_Utils::getIcon('plus-circle', '', '1.2em', '1px'); ?> <?php echo _mmt("Create Shipping Method"); ?></a>
	</div>
