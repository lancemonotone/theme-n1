 ...
 */
var MM_CaptchaIPNLogViewJS = MM_Core.extend({
	resetForm: function()
	{
		jQuery("#from_date").val("");
		jQuery("#to_date").val("");
		jQuery("#score_val").val("");
		jQuery("#score_operation").val("=");
		jQuery("#pass_fail").val("");
		jQuery("#checkout_url").val("");
	},
...
var mmjs = new MM_CaptchaIPNLogViewJS("MM_CaptchaIPNLogView", "reCAPTCHA Log");